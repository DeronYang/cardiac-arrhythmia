...
nega=-1*(nega<thnega/4);%-1 or 0
%找出非0点
interva=posi+nega;% -1 or 0 or 1
loca=find(interva);%序号
...
%正极大值点
interva2(loca(loca2(1:length(loca2))+1))=interva(loca(loca2(1:length(loca2))+1));%interva2里只保留了负正极值对的位置。
